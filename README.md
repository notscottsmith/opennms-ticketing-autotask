# OpenNMS Autotask Ticket Plugin Plugin
...
* opennms-autotask-ticket-plugin:stats
* opennms-autotask-ticket-plugin:push-topology

You can also access the REST endpoint mounted by the plugin at `http://localhost:8980/opennms/rest/autotask-ticket-plugin/ping`
