# OpenNMS Autotask Ticket Plugin
...
```
feature:repo-add mvn:org.opennms.plugins.opa.ticketing.autotask/karaf-features/0.1.0-SNAPSHOT/xml
feature:install opennms-plugins-autotask-ticket-plugin
```


```
cp assembly/kar/target/opennms-autotask-ticket-plugin-plugin.kar /opt/opennms/deploy/
feature:install opennms-plugins-autotask-ticket-plugin
```
...
* autotask:stats
* autotask:push-topology

You can also access the REST endpoint mounted by the plugin at `http://localhost:8980/opennms/rest/autotask/ping`
